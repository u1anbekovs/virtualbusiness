            ...
            <div className="container">
                <div className="mt-32">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex">
                          <div
                              className="flex flex-col text-center items-center bg-gray-800 bg-opacity-30 p-9 rounded-3xl m-4 border border-gray-700">
                              ...
                              <button onClick={() => setSet(!set)} className="text-white mt-7 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-8 py-2 flex items-center">Learn
                                  more<BsArrowRightShort/></button>
                          </div>
